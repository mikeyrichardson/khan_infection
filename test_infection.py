...
class InfectionTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        dir = 'test_files'
        test_files_info = cls.generate_test_files(cls.test_dir, num_nodes=10000, version='1.1',
                            node_with_edges_frequency=100, group_size=2000)
        cls.test_file_list = sorted(test_files_info.keys())

    @classmethod
    def tearDownClass(cls):
        for file_name in cls.test_file_list:
            os.remove(file_name)
